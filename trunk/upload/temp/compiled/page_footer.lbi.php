...
<div id="bottomNav" class="box">
 <div class="box_1">
  <div class="bNavList clearfix">
   ...
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_08559500_1241744741');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_08559500_1241744741']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_08559500_1241744741']['url']; ?>" <?php if ($this->_var['nav_0_08559500_1241744741']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_08559500_1241744741']['name']; ?></a>
...
?><br />
  <a href="http://www.ecshop.com" target="_blank" style=" font-family:Verdana; font-size:11px;">Powered by <strong><span style="color: #3366FF">ECShop</span> <span style="color: #FF9966"><?php echo $this->_var['ecs_version']; ?></span></strong></a> <?php echo $this->_var['licensed']; ?><br />
